...
bool ArrowTower3::init()
{
   ...
   /* auto baseplate = Sprite::createWithSpriteFrameName("baseplate.png");
    ...
    tower= Sprite::createWithSpriteFrameName("tower1_3.png");
	this->addChild(tower);
    schedule(schedule_selector(ArrowTower3::rotateAndShoot), 0.8f);
	return true;
}


Sprite* ArrowTower3::ArrowTowerBullet()
{
	//add by  
...
void ArrowTower3::rotateAndShoot(float dt)
{
 //   checkNearestEnemy();
...
void ArrowTower3::shoot()
{
    ...
    if(nearestEnemy!=NULL && nearestEnemy->getCurrHp() > 0 )
    {
		...
		currBullet->runAction(Sequence::create(MoveTo::create(moveDuration, offscreenPoint),
                                               CallFuncN::create(CC_CALLBACK_1(ArrowTower3::removeBullet, this)),
                                               NULL));
        currBullet = NULL;
    }
}

void ArrowTower3::removeBullet(Node* pSender)
{
    GameManager *instance = GameManager::getInstance();
