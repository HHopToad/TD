...
{  
	...
	//add by  
	//auto sprite = Sprite::createWithSpriteFrameName("failBg.png");
	auto sprite = Sprite::createWithSpriteFrameName("failBg.png");
	
    sprite->setPosition(Point(-size.width/2 , size.height / 2 ));
    this->addChild(sprite, -1);
    
   // Sprite *backItem = CCSprite::createWithSpriteFrameName("gameBack.png");
	Sprite *backItem = CCSprite::createWithSpriteFrameName("gameBack.png");
	Sprite *backItem1 = CCSprite::createWithSpriteFrameName("gameBack1.png");
    MenuItemSprite *back = MenuItemSprite::create(backItem, backItem1, CC_CALLBACK_1(FailedScene::menuBackCallback, this));
    
    back->setPosition(Point(sprite->getContentSize().width / 2, sprite->getContentSize().height* 2/ 5));
